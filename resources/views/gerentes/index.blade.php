...
<div class="row justify-content-center mt-3">
    <div class="col-md-12">
        ...
        <div class="card" style="background-color:#f9f6f4;">
            <div class="card-header">Gerente List</div>
            <div class="card-body">
                <a href="{{ route('gerentes.create') }}" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i> Add New Gerente</a>
                        ...
                        @empty
                            <td colspan="6">
                                <span class="text-danger">
                                    <strong>No Gerente Found!</strong>
                                </span>
                            </td>
                        @endforelse
                    </tbody>
